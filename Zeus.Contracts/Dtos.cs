...
public sealed record DspLiveDiagnosticsDto(
    ...
    string RolloutGate,
    bool RxAudioLevelerProfileApiAvailable,
    string RxAudioLevelerProfileEndpoint,
    string[] RxAudioLevelerSupportedProfiles,
    string RxAudioLevelerDefaultProfile,
    string RxAudioLevelerCandidateProfile,
    bool RxAudioLevelerCandidateProfileAvailable,
    bool RxAudioLevelerCandidateProfileExperimental,
    string RxAudioLevelerCapabilityStatus,
    bool WdspActive,
    bool WdspNativeLoadable,
    bool WdspEmnrPost2Available,
    bool WdspNr4SbnrAvailable,

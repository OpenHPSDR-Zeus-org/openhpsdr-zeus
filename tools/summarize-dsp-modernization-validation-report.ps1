...
function Get-EvidenceGateRecords {
    ...
    $manualTuneObserverSuggestedStepHz = Get-JsonValue $Validation "manualTuneObserverFrontendSuggestedVfoStepHz"
    $manualTuneObserverExactSuggestedVfoMhz = Get-JsonValue $Validation "manualTuneObserverFrontendExactSuggestedVfoMhz"
    $manualTuneObserverExactSuggestedShift = Get-JsonValue $Validation "manualTuneObserverFrontendExactSuggestedDialShiftHz"
    ...
    $manualTuneObserverHintText = if ($manualTuneObserverTuningHintCount -le 0) {
        ...
        "polls=$manualTuneObserverTuningHintCount shiftHz=$manualTuneObserverSuggestedShift vfoMhz=$manualTuneObserverSuggestedVfoMhz stepHz=$manualTuneObserverSuggestedStepHz exactVfoMhz=$manualTuneObserverExactSuggestedVfoMhz exactShiftHz=$manualTuneObserverExactSuggestedShift reason=$manualTuneObserverSuggestedReason distanceHz=$manualTuneObserverSuggestedDistance"
    }
    ...
    $manualTuneObserverRequireCandidateCaptureReady = Test-Truthy (Get-JsonValue $Validation "manualTuneObserverRequireCandidateCaptureReady")
    $manualTuneObserverBaseCaptureQualifiedPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverBaseCaptureQualifiedPollCount")
    $manualTuneObserverCandidateCaptureReadyPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverCandidateCaptureReadyPollCount")
    $manualTuneObserverCandidateCaptureBlockedPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverCandidateCaptureBlockedPollCount")
    $manualTuneObserverCandidateCaptureAdvisoryPollCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "manualTuneObserverCandidateCaptureAdvisoryPollCount")
    $manualTuneObserverPrimaryActionId = [string](Get-JsonValue $Validation "manualTuneObserverPrimaryManualTuneActionId")
    $manualTuneObserverPrimaryActionStatus = [string](Get-JsonValue $Validation "manualTuneObserverPrimaryManualTuneActionStatus")
    $manualTuneObserverPrimaryActionSummary = [string](Get-JsonValue $Validation "manualTuneObserverPrimaryManualTuneActionSummary")
    $manualTuneObserverPrimaryActionText = if ([string]::IsNullOrWhiteSpace($manualTuneObserverPrimaryActionId)) {
        "none"
    }
    else {
        "$manualTuneObserverPrimaryActionId/$manualTuneObserverPrimaryActionStatus"
    }
    ...
    $g2RxPeakHuntWeakOnlyPassbandQualified = Test-Truthy (Get-JsonValue $Validation "g2RxPeakHuntWeakOnlyPassbandQualified")
    $g2RxPeakHuntWeakOnlyPassbandIncomplete = Test-Truthy (Get-JsonValue $Validation "g2RxPeakHuntWeakOnlyPassbandIncomplete")
    $g2RxPeakHuntWeakOnlyOffPassband = Test-Truthy (Get-JsonValue $Validation "g2RxPeakHuntWeakOnlyOffPassband")
    $g2RxPeakHuntPassbandEvidenceMissing = Test-Truthy (Get-JsonValue $Validation "g2RxPeakHuntPassbandEvidenceMissing")
    $g2RxPeakHuntPassbandEvidenceMissingRunCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntPassbandEvidenceMissingRunCount")
    $g2RxPeakHuntRxStateDriftRunCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntRxStateDriftRunCount")
    $g2RxPeakHuntReadyPassbandWeakRunCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntReadyPassbandWeakRunCount")
    $g2RxPeakHuntWeakOnlyPassbandQualifiedRunCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntWeakOnlyPassbandQualifiedRunCount")
    $g2RxPeakHuntTargetMode = [string](Get-JsonValue $Validation "g2RxPeakHuntTargetMode")
    $g2RxPeakHuntSafetyTargetMode = [string](Get-JsonValue $Validation "g2RxPeakHuntSafetyTargetMode")
    $gates.Add((New-EvidenceGateRecord `
    ...
    $gates.Add((New-EvidenceGateRecord `
                ...
                -Remediation "Regenerate live diagnostics history after watcher summaries and JSONL traces are finalized; capture complete off-baseline, thetis-parity, current-zeus, and candidate-under-test coverage with AGC stability plus mixed weak/strong evidence before using history for tuning decisions.")) | Out-Null
    ...
    $gates.Add((New-EvidenceGateRecord `
                ...
                -Remediation "Capture at least one G2 Candidate live trace that contains both weak and strong speech samples with weak/strong output gap within the v14 parity threshold before claiming acceptance-ready volume normalization.")) | Out-Null
...
function Get-LiveMatrixAcceptanceCommandSteps {
    return @(
        ...
        'powershell -NoProfile -ExecutionPolicy Bypass -File tools\run-dsp-live-diagnostics-matrix.ps1 -BundleDir "$bundleDir" -ComparisonId candidate-under-test -IndexPath "$bundleDir\artifacts\live-diagnostics-trace-index.candidate.json" -ReportPath "$bundleDir\artifacts\live-diagnostics-matrix-report.candidate.json" -Samples 60 -IntervalMs 1000',
        ...
        'powershell -NoProfile -ExecutionPolicy Bypass -File tools\compare-dsp-live-diagnostics-matrix.ps1 -BundleDir "$bundleDir" -BaselineIndexPath "$bundleDir\artifacts\live-diagnostics-trace-index.baseline.json" -CandidateIndexPath "$bundleDir\artifacts\live-diagnostics-trace-index.candidate.json" -BaselineComparisonId current-zeus -CandidateComparisonId candidate-under-test -ReportPath "$bundleDir\artifacts\live-diagnostics-trace-comparison.json" -FailOnRegression',
        'powershell -NoProfile -ExecutionPolicy Bypass -File tools\compare-dsp-live-diagnostics-matrix.ps1 -BundleDir "$bundleDir" -BaselineIndexPath "$bundleDir\artifacts\live-diagnostics-trace-index.thetis-parity.json" -CandidateIndexPath "$bundleDir\artifacts\live-diagnostics-trace-index.candidate.json" -BaselineComparisonId thetis-parity -CandidateComparisonId candidate-under-test -ReportPath "$bundleDir\artifacts\live-diagnostics-trace-comparison.thetis-parity.json" -FailOnRegression',
    ...
    switch ($gateId) {
        ...
        "wdsp-runtime-artifact-audit" {
            $Actions.Add((New-AcceptanceActionRecord `
                        ...
                        -BlocksDefaultChange:$true `
                        -Reason $reason `
                        -CommandTemplate 'powershell -NoProfile -ExecutionPolicy Bypass -File tools\audit-wdsp-runtime-artifacts.ps1 -ReportPath "$bundleDir\artifacts\wdsp-runtime-artifact-audit.json" -FailOnMissingWinX64CurrentNr' `
        ...
        "live-matrix-artifact-control" {
            ...
            if ([string]::Equals($artifactStatus, "artifact-review", [StringComparison]::OrdinalIgnoreCase)) {
                ...
                if ([string]::IsNullOrWhiteSpace($bestComparisonId)) {
                    $bestComparisonId = "candidate-under-test"
                }
                ...
                $Actions.Add((New-AcceptanceActionRecord `
                            ...
                            -ManualAction "On G2, prefer a cleaner active window before using the current best matrix run for candidate DSP tuning. Listen for metallic or burbling speech artifacts and avoid low-evidence lift or unsupported texture-fill windows." `
        ...
        "live-history-mixed-weak-strong" {
            ...
            if ($matrixHuntReady -and $null -ne $matrixBestRun) {
                ...
                $Actions.Add((New-AcceptanceActionRecord `
                            ...
                            -ManualAction "On G2, recreate the active weak+strong signal window represented by the best matrix run before executing the targeted recapture. Keep candidate DSP opt-in and do not change defaults." `
                ...
                elseif ($manualObserverNearStrongCandidateReady) {
                    ...
                    $manualBestObservedSuggestedStepHz = Get-JsonValue $Validation "manualTuneObserverBestObservedVfoSuggestedVfoStepHz"
                    $manualBestObservedExactSuggestedVfoHz = Get-JsonValue $Validation "manualTuneObserverBestObservedVfoExactSuggestedVfoHz"
                    $manualBestObservedExactSuggestedVfoMhz = Get-JsonValue $Validation "manualTuneObserverBestObservedVfoExactSuggestedVfoMhz"
                    $manualBestObservedExactSuggestedShiftHz = Get-JsonValue $Validation "manualTuneObserverBestObservedVfoExactSuggestedDialShiftHz"
                    ...
                    if ($manualObserverHasObservedTarget) {
                        $manualObservedTuneText = if ($manualBestObservedHasSuggestedVfo) {
                            "suggestedVfoMhz=$manualBestObservedSuggestedVfoMhz, suggestedVfoHz=$manualBestObservedSuggestedVfoHz, shiftHz=$manualBestObservedSuggestedShiftHz, stepHz=$manualBestObservedSuggestedStepHz, exactSuggestedVfoMhz=$manualBestObservedExactSuggestedVfoMhz, exactSuggestedVfoHz=$manualBestObservedExactSuggestedVfoHz, exactShiftHz=$manualBestObservedExactSuggestedShiftHz, reason='$manualBestObservedSuggestedReason'"
                        }
                        else {
                ...
                if (Test-Truthy (Get-JsonValue $Validation "g2RxPeakHuntReportPresent")) {
                    ...
                    $peakHuntPassbandWeakSamples = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntPassbandQualifiedWeakInputSampleCount")
                    $peakHuntFrontendNearPassbandSamples = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntFrontendNearPassbandSampleCount")
                    $peakHuntPassbandEvidenceMissing = Test-Truthy (Get-JsonValue $Validation "g2RxPeakHuntPassbandEvidenceMissing")
                    $peakHuntRxStateDriftRunCount = Get-IntegerValueOrDefault (Get-JsonValue $Validation "g2RxPeakHuntRxStateDriftRunCount")
                    ...
                    $peakHuntReason = " Latest G2 peak-hunt report status='$peakHuntStatus', weakSamples=$peakHuntWeakSamples, strongSamples=$peakHuntStrongSamples, passbandWeakSamples=$peakHuntPassbandWeakSamples, frontendNearPassbandSamples=$peakHuntFrontendNearPassbandSamples, passbandEvidenceMissing=$peakHuntPassbandEvidenceMissing, rxStateDriftRuns=$peakHuntRxStateDriftRunCount, referencedWindows=$peakHuntWindowReadyCount/$peakHuntWindowCount, referencedProblems=$peakHuntProblemCount, bestFrequencyHz=$peakHuntBestFrequencyHz, bestScore=$peakHuntBestScore, bestStatus='$peakHuntBestStatus', bestReportPath='$peakHuntBestReportPath'."
                    ...
                    if ($peakHuntStatus.StartsWith("weak-only", [StringComparison]::Ordinal) -or $peakHuntBestStatus -eq "missing-strong-input" -or ($peakHuntWeakSamples -gt 0 -and $peakHuntStrongSamples -le 0)) {
                        ...
                        if ($peakHuntPassbandEvidenceMissing) {
                            $peakHuntReason += " It also lacks stable passband-qualified weak evidence, so do not use it to tune Candidate weak-signal preservation."
                ...
                $peakHuntCommandSteps = @(
                    ...
                    'powershell -NoProfile -ExecutionPolicy Bypass -File tools\run-dsp-live-diagnostics-matrix.ps1 -BundleDir "$bundleDir" -ComparisonId candidate-under-test -IndexPath "$bundleDir\artifacts\live-diagnostics-trace-index.mixed-weak-strong-followup.json" -ReportPath "$bundleDir\artifacts\live-diagnostics-matrix-report.mixed-weak-strong-followup.json" -Samples 90 -IntervalMs 1000 -ContinueOnError',
                    'powershell -NoProfile -ExecutionPolicy Bypass -File tools\summarize-dsp-live-diagnostics-history.ps1 -BundleDir "$bundleDir" -ReportPath "$bundleDir\artifacts\live-diagnostics-history.json"',
                    'powershell -NoProfile -ExecutionPolicy Bypass -File tools\validate-dsp-modernization-bundle.ps1 -BundleDir "$bundleDir" -RequireArtifactFiles -ReportPath "$bundleDir\validation-report.json"',
                    'powershell -NoProfile -ExecutionPolicy Bypass -File tools\summarize-dsp-modernization-validation-report.ps1 -BundleDir "$bundleDir" -ReportPath "$bundleDir\validation-triage-report.json" -MarkdownPath "$bundleDir\validation-triage-report.md" -FailOnIssues'
                )
                $Actions.Add((New-AcceptanceActionRecord `
                            ...
                            -ManualAction "Use G2 on an active SSB/CW-adjacent window with both weak and strong speech samples. If the operator is tuning manually, start with watch-dsp-manual-tune-observer so no VFO/LO writes occur; otherwise use run-dsp-g2-rx-peak-hunt to scan current frontend peaks and omit -AllowRetune for a current-VFO-only dry run.$peakHuntManualContext Then capture candidate DSP live diagnostics, regenerate artifacts/live-diagnostics-history.json, and rerun strict validation. The v14 history must report mixedWeakStrongEvidenceStatus=ready." `
                            -ExpectedArtifact 'artifacts/live-diagnostics-history.json' `
                            -ExpectedArtifacts @(
                                'artifacts/manual-tune-observer-report.json',
        ...
        "live-history-provenance" {
            ...
            $Actions.Add((New-AcceptanceActionRecord `
                        ...
                        -ExpectedArtifact 'artifacts/live-diagnostics-history.json' `
                        -FollowUp "Use history only to choose candidate comparison windows; it does not approve defaults. Coverage repair must capture off-baseline, Thetis, current-Zeus, and candidate DSP before regenerating history.")) | Out-Null
        }
...
function Build-MarkdownReport {
    ...
    if (Test-Truthy (Get-JsonValue $Report "manualTuneObserverReportPresent")) {
        ...
        $lines.Add("- Frontend tuning hint polls/shift/VFO/step/exact/reason/distance: $(Get-JsonValue $Report "manualTuneObserverFrontendTuningHintPollCount") / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverFrontendSuggestedDialShiftHz")) Hz / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverFrontendSuggestedVfoMhz")) MHz / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverFrontendSuggestedVfoStepHz")) Hz / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverFrontendExactSuggestedVfoMhz")) MHz / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverFrontendSuggestedTuneReason")) / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverFrontendSuggestedFilterDistanceHz")) Hz") | Out-Null
        $lines.Add("- Candidate capture gate required/base-qualified/ready/blocked/advisory polls: $(Get-JsonValue $Report "manualTuneObserverRequireCandidateCaptureReady") / $(Get-JsonValue $Report "manualTuneObserverBaseCaptureQualifiedPollCount") / $(Get-JsonValue $Report "manualTuneObserverCandidateCaptureReadyPollCount") / $(Get-JsonValue $Report "manualTuneObserverCandidateCaptureBlockedPollCount") / $(Get-JsonValue $Report "manualTuneObserverCandidateCaptureAdvisoryPollCount")") | Out-Null
        $lines.Add("- Primary manual action: $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverPrimaryManualTuneActionId")) / $(Format-MarkdownCell (Get-JsonValue $Report "manualTuneObserverPrimaryManualTuneActionStatus"))") | Out-Null
    ...
    if (Test-Truthy (Get-JsonValue $Report "g2RxPeakHuntReportPresent")) {
        ...
        $lines.Add("- RX-only/VFO restored/radio LO restored/mode restored/retune attempts: $(Get-JsonValue $Report "g2RxPeakHuntSafetyRxOnly") / $(Get-JsonValue $Report "g2RxPeakHuntSafetyOriginalVfoRestored") / $(Get-JsonValue $Report "g2RxPeakHuntSafetyOriginalRadioLoRestored") / $(Get-JsonValue $Report "g2RxPeakHuntSafetyOriginalModeRestored") / $(Get-JsonValue $Report "g2RxPeakHuntRetuneAttemptCount")") | Out-Null
        $lines.Add("- Target/original/restored mode: $(Format-MarkdownCell (Get-JsonValue $Report "g2RxPeakHuntTargetMode")) / $(Format-MarkdownCell (Get-JsonValue $Report "g2RxPeakHuntHardwareOriginalMode")) / $(Format-MarkdownCell (Get-JsonValue $Report "g2RxPeakHuntHardwareRestoredMode"))") | Out-Null
        ...
        $lines.Add("- Weak-only passband quality qualified/incomplete/off-passband/missing/drift-runs: $(Get-JsonValue $Report "g2RxPeakHuntWeakOnlyPassbandQualified") / $(Get-JsonValue $Report "g2RxPeakHuntWeakOnlyPassbandIncomplete") / $(Get-JsonValue $Report "g2RxPeakHuntWeakOnlyOffPassband") / $(Get-JsonValue $Report "g2RxPeakHuntPassbandEvidenceMissing") / $(Get-JsonValue $Report "g2RxPeakHuntRxStateDriftRunCount")") | Out-Null
        ...
        $lines.Add("- Live diagnostics NR mode/ready: $(Format-MarkdownCell (Get-JsonValue $Report "g2RxPeakHuntLiveDiagnosticsEffectiveNrMode")) / $(Get-JsonValue $Report "g2RxPeakHuntLiveDiagnosticsReadyForCandidateTuning")") | Out-Null
...
$report = [ordered]@{
    ...
    manualTuneObserverBestObservedVfoSuggestedVfoStepHz = Get-JsonValue $validation "manualTuneObserverBestObservedVfoSuggestedVfoStepHz"
    manualTuneObserverBestObservedVfoExactSuggestedVfoHz = Get-JsonValue $validation "manualTuneObserverBestObservedVfoExactSuggestedVfoHz"
    manualTuneObserverBestObservedVfoExactSuggestedVfoMhz = Get-JsonValue $validation "manualTuneObserverBestObservedVfoExactSuggestedVfoMhz"
    manualTuneObserverBestObservedVfoExactSuggestedDialShiftHz = Get-JsonValue $validation "manualTuneObserverBestObservedVfoExactSuggestedDialShiftHz"
    ...
    manualTuneObserverFrontendSuggestedVfoStepHz = Get-JsonValue $validation "manualTuneObserverFrontendSuggestedVfoStepHz"
    manualTuneObserverFrontendExactSuggestedDialShiftHz = Get-JsonValue $validation "manualTuneObserverFrontendExactSuggestedDialShiftHz"
    manualTuneObserverFrontendExactSuggestedVfoHz = Get-JsonValue $validation "manualTuneObserverFrontendExactSuggestedVfoHz"
    manualTuneObserverFrontendExactSuggestedVfoMhz = Get-JsonValue $validation "manualTuneObserverFrontendExactSuggestedVfoMhz"
    ...
    manualTuneObserverPrimaryManualTuneAction = Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneAction"
    manualTuneObserverPrimaryManualTuneActionId = [string](Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneActionId")
    manualTuneObserverPrimaryManualTuneActionStatus = [string](Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneActionStatus")
    manualTuneObserverPrimaryManualTuneActionSummary = [string](Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneActionSummary")
    manualTuneObserverPrimaryManualTuneActionManualAction = [string](Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneActionManualAction")
    manualTuneObserverPrimaryManualTuneActionCommandTemplate = [string](Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneActionCommandTemplate")
    manualTuneObserverPrimaryManualTuneActionExpectedEvidence = [string](Get-JsonValue $validation "manualTuneObserverPrimaryManualTuneActionExpectedEvidence")
    manualTuneObserverReferencedCaptureCount = Get-IntegerValueOrDefault (Get-JsonValue $validation "manualTuneObserverReferencedCaptureCount")
    manualTuneObserverReferencedCaptureReadyCount = Get-IntegerValueOrDefault (Get-JsonValue $validation "manualTuneObserverReferencedCaptureReadyCount")
    manualTuneObserverReferencedCaptureProblemCount = Get-IntegerValueOrDefault (Get-JsonValue $validation "manualTuneObserverReferencedCaptureProblemCount")
    ...
    g2RxPeakHuntSafetyTemporaryModeRequested = Test-Truthy (Get-JsonValue $validation "g2RxPeakHuntSafetyTemporaryModeRequested")
    g2RxPeakHuntSafetyTargetMode = [string](Get-JsonValue $validation "g2RxPeakHuntSafetyTargetMode")
    g2RxPeakHuntSafetyOriginalModeRestoreAttempted = Test-Truthy (Get-JsonValue $validation "g2RxPeakHuntSafetyOriginalModeRestoreAttempted")
    g2RxPeakHuntSafetyOriginalModeRestored = Test-Truthy (Get-JsonValue $validation "g2RxPeakHuntSafetyOriginalModeRestored")
    ...
    g2RxPeakHuntHardwareOriginalMode = [string](Get-JsonValue $validation "g2RxPeakHuntHardwareOriginalMode")
    g2RxPeakHuntHardwareRestoredMode = [string](Get-JsonValue $validation "g2RxPeakHuntHardwareRestoredMode")
    ...
    g2RxPeakHuntLiveDiagnosticsReadyForCandidateTuning = Test-Truthy (Get-JsonValue $validation "g2RxPeakHuntLiveDiagnosticsReadyForCandidateTuning")
